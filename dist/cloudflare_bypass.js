...
var CloudflareBypassImpl = /** @class */ (function () {
    function CloudflareBypassImpl() {
    ...
    CloudflareBypassImpl.prototype.ensureLoaded = function () {
    ...
    CloudflareBypassImpl.prototype.ensureUnloaded = function () {
        return __awaiter(this, void 0, void 0, function () {
    ...
    CloudflareBypassImpl.prototype.fetch = function (uri) {
        return __awaiter(this, void 0, void 0, function () {
            var page, content;
            var _this = this;
            return __generator(this, function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, page.$$eval(cssSelector, function (els) { return els.map(function (el) { return el.textContent; }); })];
                    case 4:
                        matchTexts = _a.sent();
                        // Close the page async, logging an error if we run into one
                        page.close()["catch"](function (reason) {
