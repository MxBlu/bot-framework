...
var MessengerTopic = /** @class */ (function () {
    function MessengerTopic(name) {
        this.name = name;
    ...
    MessengerTopic.prototype.subscribe = function (funcName, func) {
    ...
    // Assumes topic does exist
    MessengerTopic.prototype.unsubscribe = function (funcName) {
        if (!this.subscribers.has(funcName)) {
    ...
    // Assumes topic does exist
    MessengerTopic.prototype.notify = function (data) {
        var _this = this;
        this.logger.trace('Notifying topic');
        this.lastData = data;
        this.subscribers.forEach(function (f) { return __awaiter(_this, void 0, void 0, function () {
    ...
    // Assumes topic does exist
    MessengerTopic.prototype.getLastData = function () {
        return this.lastData;
    };
    return MessengerTopic;
}());
export { MessengerTopic };
